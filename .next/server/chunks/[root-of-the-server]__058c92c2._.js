...
"[project]/.next-internal/server/app/api/bills/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
async function DELETE(_, { params }) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].item.deleteMany({
        where: {
            billId: id
        }
    });
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].billParticipant.deleteMany({
        where: {
            billId: id
        }
    });
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].bill.delete({
        where: {
            id
        }
    });
...
async function PATCH(req, { params }) {
    ...
    const { paidByContactId, subtotalCents, taxRatePct, tipRatePct, convenienceFeeRatePct } = body;
    if (paidByContactId === undefined && subtotalCents === undefined && taxRatePct === undefined && tipRatePct === undefined && convenienceFeeRatePct === undefined) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].bill.update({
        where: {
            id
        },
        data
...
//# sourceMappingURL=%5Broot-of-the-server%5D__058c92c2._.js.map