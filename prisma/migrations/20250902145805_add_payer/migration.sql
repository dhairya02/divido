...
INSERT INTO "new_Bill" ("convenienceFeeRatePct", "createdAt", "currency", "date", "id", "subtotalCents", "taxMode", "taxRatePct", "tipRatePct", "title", "venue") SELECT "convenienceFeeRatePct", "createdAt", "currency", "date", "id", "subtotalCents", "taxMode", "taxRatePct", "tipRatePct", "title", "venue" FROM "Bill";
DROP TABLE "Bill";
